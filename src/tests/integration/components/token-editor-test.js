...
describe('Integration | Component | token-editor', function () {
  ...
  [
    ...
    it(
      ...
      async function () {
        ...
        await click(`.type-field .option-${type}`);
        expect(find('.inviteDetails-field')).to.not.exist;
      }
    );
  });
  ...
  it(
    ...
    async function () {
      ...
      await click('.type-field .option-invite');
      expect(find('.inviteDetails-field')).to.exist;
    }
  );
    ...
    if (targetModelName) {
      ...
      if (!noPrivileges) {
        ...
        it(
          ...
          async function () {
            ...
            expectToHaveValue(this, 'privileges', {
              privilegesTarget: targetModelName,
              privileges: [
        ...
        it(
          ...
          async function () {
            ...
            await click('.type-field .option-invite');
            await selectChoose('.inviteType-field', label);
            expect(find('.invitePrivilegesDetails-field'))
              .to.not.exist;
          }
        );
      }
      ...
      it(
        ...
        async function () {
          ...
          await click('.type-field .option-invite');
          await selectChoose('.inviteType-field', label);
          expect(find('.inviteTargetDetails-field'))
            .to.not.exist;
        }
      );
    }
  ...
  ['view', 'edit'].forEach(mode => {
    it(`does not show "no caveats" warning in ${mode} mode`, async function () {
      ...
      await render(hbs `<TokenEditor @mode={{mode}} />`);
  ...
  it(
    ...
    async function () {
      ...
      await toggleCaveatsSection();
      expect(find('.serviceCaveat-field')).to.exist;
      expect(find('.interfaceCaveat-field')).to.exist;
      expect(find('.dataAccessCaveats-field')).to.exist;
    }
  );
  ...
  it(
    ...
    async function () {
      ...
      await toggleCaveatsSection();
      expect(find('.serviceCaveat-field')).to.not.exist;
      expect(find('.interfaceCaveat-field')).to.exist;
      expect(find('.dataAccessCaveats-field')).to.not.exist;
    }
  );
  ...
  it(
    ...
    async function () {
      ...
      await toggleCaveatsSection();
      expect(find('.serviceCaveat-field')).to.not.exist;
      expect(find('.interfaceCaveat-field')).to.not.exist;
      expect(find('.dataAccessCaveats-field')).to.not.exist;
    }
  );
  ...
  it('calls injected onSubmit on submit click', async function () {
    ...
    await render(hbs `<TokenEditor @mode="create" @onSubmit={{action submit}} />`);
  ...
  it(
    ...
    async function () {
      ...
      await render(hbs `<TokenEditor @mode="view" @token={{token}} />`);
  ...
  it(
    ...
    async function () {
      ...
      await render(hbs `<TokenEditor @mode="edit" @token={{token}} />`);
  ...
  it(
    ...
    async function () {
      ...
      await render(hbs `<TokenEditor @mode="edit" @onCancel={{action cancel}} />`);
  ...
  it(
    ...
    async function () {
      ...
      await render(hbs `<TokenEditor @mode="create" @token={{token}} />`);
...
function isCaveatExpanded(caveatName) {
  return Boolean(find(`.${caveatName}Caveat-field > .field-component`));
}

function areAllCaveatsExpanded() {
  return findAll('.caveat-group').length === caveats.length;
}
