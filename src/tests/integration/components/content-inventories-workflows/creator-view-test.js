...
describe('Integration | Component | content inventories workflows/creator view',
  function () {
    setupComponentTest('content-inventories-workflows/creator-view', {
      integration: true,
    });
    ...
    it('has class "content-inventories-workflows-creator-view"', function () {
      this.render(hbs `{{content-inventories-workflows/creator-view}}`);

      expect(this.$().children()).to.have.class('content-inventories-workflows-creator-view')
    ...
    it('shows empty workflow schema details form in edit mode', async function () {
      ...
      const $form = this.$('.workflow-details-form');
...
async function render(testCase) {
  testCase.render(hbs `{{content-inventories-workflows/creator-view
