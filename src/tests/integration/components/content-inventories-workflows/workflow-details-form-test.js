...
describe('Integration | Component | content inventories workflows/workflow details form',
  function () {
    setupComponentTest('content-inventories-workflows/workflow-details-form', {
      integration: true,
    });
    ...
    it('has class "workflow-details-form"', function () {
      this.render(hbs `{{content-inventories-workflows/workflow-details-form}}`);

      expect(this.$().children()).to.have.class('workflow-details-form')
...
async function render(testCase) {
  testCase.render(hbs `{{content-inventories-workflows/workflow-details-form
    mode=mode
