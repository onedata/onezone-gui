...
describe('Integration | Component | content inventories functions/list view',
  function () {
    setupComponentTest('content-inventories-functions/list-view', {
      integration: true,
    });
    ...
    it('has class "content-inventories-functions-list-view"', function () {
      this.render(hbs `{{content-inventories-functions/list-view}}`);

      expect(this.$().children()).to.have.class('content-inventories-functions-list-view')
    ...
    it('shows list of lambda functions of given automation inventory', async function () {
      await render(this);
...
async function render(testCase) {
  testCase.render(hbs `{{content-inventories-functions/list-view
