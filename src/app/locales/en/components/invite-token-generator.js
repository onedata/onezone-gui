...
export default {
  ...
  onedatifyLimitationsDescription: {
    withRegistrationToken: '<strong>Tokens included below will expire in 2 weeks and have no usage count limit.</strong>',
    withoutRegistrationToken: '<strong>The support token included below will expire in 2 weeks and has no usage count limit.</strong>',
  },
  ...
  ozRegistrationTokenVariableDescription: {
    content: 'A valid <code>{{variable}}</code> must be defined for the above command to work. Please contact a Onezone admin to acquire such a token.',
