  ...
  operations: {
    merge: {
      ...
      revisionConflictWarning: {
        upload: {
          atmLambda: 'Selected lambda already has revision #{{revisionNumber}}. As lambda revisions cannot be replaced, the revision from the uploaded file will be inserted as the last (newest) revision.',
        ...
        duplication: {
          atmLambda: 'Selected lambda already has revision #{{revisionNumber}}. As lambda revisions cannot be replaced, the revision from the source lambda will be inserted as the last (newest) revision.',
