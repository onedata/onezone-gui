export default {
  ...
  templates: {
    ...
    oneclientInOneprovider: {
      ...
      text: 'Mount Onedata in Linux filesystems natively (FUSE)',
      tooltip: 'Similar to ONECLIENT ACCESS token, but limits the allowed connection hosts to specific Oneprovider(s).',
    },
    readonlyData: {
      title: 'Read‐only data access',
      newTokenNamePrefix: 'Read-only data',
      text: 'Read data from any space via any interface',
      tooltip: 'Access token that allows only reading data from any of your Onedata spaces (may be further limited to specific spaces, paths, or files).',
    },
    readonlyDataForUser: {
      ...
      tooltip: 'Similar to READ-ONLY DATA ACCESS token, but can be used only by specific user(s), who are required to present a proof of identity (an identity token) alongside.',
    },
    restrictedData: {
      ...
      tooltip: 'Access token that is suitable only for data access (read or write) and limits the spaces, directories, or files that are visible and accessible with it.',
    },
    onepanelRest: {
      ...
      tooltip: 'Access token suitable for Onepanel ',
      tooltip2: '. Allows administration and management of deployed services (Onezone, Oneproviders).',
      linkName1: 'REST API',
      link1: 'https://onedata.org/#/home/api/stable/onepanel',
    },
    identity: {
      title: 'Identity proof',
      text: 'Prove your identity without granting access',
      tooltip: 'Identity token that proves your identity, but carries no authorization to perform any operation in the system. Proving identity with an identity token is required to satisfy a consumer caveat in another token (e.g. READ-ONLY ACCESS FOR SPECIFIC USER).',
    },
    custom: {
      title: 'Custom',
    },
