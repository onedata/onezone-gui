export default {
  ...
  text: 'Deregistering this Oneprovider from Onezone will cease its support for all spaces and the data kept on its storage backends will be irreversibly lost (except for those with storage synchronization enabled). As a result, certain users and groups may permanently lose their data.',
  cannotUndone: 'This operation cannot be undone.',
