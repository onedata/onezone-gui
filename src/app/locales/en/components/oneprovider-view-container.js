export default {
  ...
  collapsedSelectorHint: {
    basicInfo: 'You can browse your data and related resources such as shares and transfers via any Oneprovider that supports the current space. The Oneprovider is automatically chosen for you when you enter the space browser.',
    multi: {
    ...
    single: {
      ...
      extInfo:
        '<strong>This space is currently supported by single Oneprovider.</strong> You will be able to switch between Oneproviders when you get another support for your space.',
    },
    close: 'Close',
  },
};
